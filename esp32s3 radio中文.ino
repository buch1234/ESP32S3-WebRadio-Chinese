/*
中文显示日期，星期，时间，音量。电台名称，歌名和歌手在线解析，可显示中文。
当天天气温度风力等。未来三天天气预报。
环形缓冲，双核cpu利用。播放，和显示分开

定义输出 I2S_DOUT 39   I2S_BCLK 40  I2S_LRC 41
开发板 esp32 3.1.11
必要的库：2025.03.13最新的库
ESP32-aduioii2s/master by schreibfaul1 3.0.13 ,  
...
#define I2S_DOUT 39
#define I2S_BCLK 40
#define I2S_LRC 38 // PCM5102 = 38  MAX98357 = 41
